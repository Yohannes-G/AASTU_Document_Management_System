<<<<<<< HEAD
# Generated by Django 3.0.7 on 2021-09-01 14:11
=======
# Generated by Django 3.2.5 on 2021-08-29 09:18
...
=======
            ...
            fields=[
                ...
                ('doc_file', models.FileField(blank=True, upload_to='')),
                ('doc_department', models.CharField(choices=[('Colledge', 'Colledge'), ('Directories', 'Directories'), ('COE', 'COE')], default='Colledge', max_length=20)),
                ('doc_date', models.DateTimeField(auto_now_add=True)),
                ('doc_receiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Receiver', to=settings.AUTH_USER_MODEL)),
                ('doc_sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Sender', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
