# Generated by Django 3.2.5 on 2021-09-17 06:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reply_receiver', models.ManyToManyField(related_name='reply_sender', to='DocumentManagement.ReceiverUser')),
                ('reply_sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reply_receiver', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='sender', to='DocumentManagement.ReceiverUser'),
        ),
        migrations.AddField(
            model_name='message',
            name='message_sender',
